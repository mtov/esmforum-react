...
function Sobre () {
  return (
    <div className="container">
      ...
      <br></br>
      <p> O <b>ESM Forum</b> é um sistema de demonstração do livro 
         <a href="https://engsoftmoderna.info/">Engenharia de Software Moderna</a>.</p> 
    
      <p> O sistema é um fórum muito simples de perguntas e respostas.</p>
